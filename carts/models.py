...
class Cart(models.Model):
    ...
    created_timestamp = models.DateTimeField( auto_now_add=True, verbose_name='Date adding')
    ...
    def __str__(self):
        ...
        return f'Nameless basket | Product {self.product.name} | Quantity{self.quantity}'
